...
<div x-cloak
    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden">
        ...
        <div class="bg-blue-600 px-6 py-5 text-white">
            <h3 class="text-2xl font-semibold text-center">New Original Receipt</h3>
        </div>
            ...
            <form action="{{ route('OriginalReceipt.store') }}" method="POST">
                ...
                <div class="mb-8">
                    ...
                    <input type="number"
                           ...
                           class="w-full text-center text-4xl font-bold border border-gray-300 rounded-xl px-6 py-5 focus:ring-4 focus:ring-blue-200 focus:border-blue-500 outline-none transition-all"
                           placeholder="000000"
                           required>
                </div>
